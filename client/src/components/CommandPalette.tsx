      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/4 left-1/2 -translate-x-1/2 w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden z-50"
          >
            <div className="border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center px-4">
                ...
                <input
                  ...
                  className="flex-1 py-4 bg-transparent text-gray-900 dark:text-gray-100 placeholder-gray-500 focus:outline-none"
                />
              </div>
            </div>
